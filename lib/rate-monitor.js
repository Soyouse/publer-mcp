...
const WINDOW_MS = 2 * 60 * 1000; // fenêtre Publer = 2 min (rate-limit par-compte, doc)
const SOFT_LIMIT = 100; // débit nominal Publer = 100 req/2min/compte
const WARN_RATIO = 0.4; // alerte si ≥40% de la fenêtre part en réponses invalides (40/2min)
